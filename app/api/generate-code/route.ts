...
export async function POST(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    let dummyProject = {
      "timestamp": "2025-11-17T11:32:28.670Z",
      "project": {
        "analysis": {
          "useCase": {
            "features": [
    ...
    try {
      ...
      const logFile = path.join(logsDir, `project-data-${timestamp}.json`)
    ...
    console.log(project.onboardingContext, 'this is project')
